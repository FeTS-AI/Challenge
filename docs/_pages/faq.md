...
2. Once your IPP account is approved, login to [CBICA's Image Processing Portal](https://ipp.cbica.upenn.edu/) and then click on the application **FeTS 2021: Registration**, under the **MICCAI FeTS 2021** group.
